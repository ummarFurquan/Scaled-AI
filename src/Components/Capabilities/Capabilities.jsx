...
import CapabilityImg from '../../assets/capabilities.png'
...
const Capabilities = () => {
  ...
  useEffect(() => {
    const tagline = document.querySelector('.capability-tagline');

    if (tagline) {
      // Calculate the animation duration and delay
      const animationDuration = 3500; // 3.5s
      const animationDelay = 2000; // 0.5s

      // Set a timeout to remove the caret after animation completion
      const timeoutId = setTimeout(() => {
        tagline.style.borderRight = 'none'; // Remove the caret
  ...
  return (
    <>
    <div className="image-container" style={{ width: '100vw', marginTop: '0px' }}>
  <img src={CapabilityImg} alt="" style={{ width: '100%', height: '70vh', objectFit: 'cover', filter: 'brightness(60%)' }} />
  <div className="tag-card">
    <h2 className='capability-tagline'>Driving Digital Excellence, Together</h2>
  </div>
</div>
      <div className="top" style={{ padding: '50px' }}>
        <div style={{ display: 'flex', justifyContent: 'center', margin: '0 -10px' }}>
          <div className="card" style={{ boxShadow: 'rgba(0, 0, 0, 0.19) 0px 10px 20px, rgba(0, 0, 0, 0.10) 0px 6px 6px', borderRadius: '10px', overflow: 'hidden', maxWidth: '1000px', width: '100%', textAlign: 'left', marginBottom: '10px', marginTop: '50px' }}>
            <div className="card-body" style={{ padding: '20px' }}>
              <div className="card-heading" style={{display:'flex', justifyContent:'center', alignItems:'center',overflow:'hidden'}}>
              <h2 style={{ marginBottom: '20px', color: '#dc3545', overflow: 'hidden' }}>Overview</h2>
              </div>
              <p style={{ color: '#555', lineHeight: '2.2', fontSize:'20px' }}>
                ScaledAI is a dynamic women owned small business that focuses on aligning the technology needs of the public sector to enhance performance, safeguard investments, and achieve modernization and digital transformation objectives.
                <br/>
                We understand the mission-critical nature of Federal IT infrastructure and our goal is to help the federal government navigate the constantly evolving technology landscape. By leveraging the latest advancements, including structured IT management, cloud modernization, and governance strategies, ScaledAI empowers our clients to stay ahead.
                <br/>
                Our commitment is to deliver scalable digital solutions that adhere to compliance and budget constraints and provide tangible cost savings throughout the technology and organizational life cycle.
              </p>
            </div>
          </div>
        </div>
        ...
        <Fade duration={1000} triggerOnce='true'>
          <div className="card" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', padding: '10px', width: '80vw', margin: '0 auto' }}>
            <div className="card-body" style={{ textAlign: 'center' }}>
              ...
              <p>Harness the power of data, machine learning, and AI for transformative insights.</p>
      ...
      <div style={{ margin: '20px 0', width: '100vw', backgroundColor: '#fff', padding: '20px' }}>
        <Fade duration={1000} triggerOnce='true'>
          <div className="card" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', padding: '10px', width: '80vw', margin: '0 auto' }}>
            <div className="card-body" style={{ textAlign: 'center' }}>
              <h2 style={{ overflow: 'hidden', padding: '10px' }}>Cloud Computing</h2>
              <p>Optimize your IT landscape with scalable cloud and infrastructure solutions.</p>
              <div className="icons-grid">
                <div className="icon-item">
        ...
        <Fade duration={1000} triggerOnce='true'>
          <div className="card" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', padding: '10px', width: '80vw', margin: '0 auto' }}>
            <div className="card-body" style={{ textAlign: 'center' }}>
              ...
              <p>Safeguard your organization with advanced cyber security, risk, and compliance services.</p>
              <div className="icons-grid">
                <div className="icon-item">
        ...
        <Fade duration={1000} triggerOnce={true}>
          <div className="card" style={{ display: 'flex', justifyContent: 'center', alignItems: 'center', boxShadow: '0 4px 8px rgba(0,0,0,0.1)', padding: '10px', width: '80vw', margin: '0 auto' }}>
            <div className="card-body" style={{ textAlign: 'center' }}>
              ...
              <p>Accelerate innovation and efficiency through our comprehensive digital transformation expertise.</p>
              <div className="icons-grid">
                <div className="icon-item">
